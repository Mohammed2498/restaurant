<div class="sm:col-span-6">
    ...
    <div class="mt-1">
        <input value="{{old('name',$category->name)}}" type="text" id="name" name="name"
        ...
        <div class="mt-1">
                                <textarea id="description" name="description"
                                          class="shadow-sm focus:ring-indigo-500 appearance-none bg-white border
                                           py-2 px-3 text-base leading-normal transition duration-150
                                           ease-in-out focus:border-indigo-500 block w-full sm:text-sm
                                           border-gray-300 rounded-md @error('description') border-red-400 @enderror">
